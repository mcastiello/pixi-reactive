...
import { PixiCanvas, PixiSprite, PixiTilingSprite, ColorMatrixFilter, DesaturateEffect } from 'pixi-reactive';
...
const DesaturateEffectDoc: React.FC = () => {
  const [enabled, setEnabled] = useState(true);
  const toggle = useCallback(() => setEnabled(!enabled), [enabled]);

  return (
    <>
      <StyledTitle>DesaturateEffect</StyledTitle>
      <StyledIntroduction>This effect will remove the saturation from the scene.</StyledIntroduction>
...
export default DesaturateEffectDoc;
