...
import { PixiCanvas, PixiSprite, PixiTilingSprite, ColorMatrixFilter, TechnicolorEffect } from 'pixi-reactive';
...
const TechnicolorEffectDoc: React.FC = () => {
  const [enabled, setEnabled] = useState(true);
  const toggle = useCallback(() => setEnabled(!enabled), [enabled]);

  return (
    <>
      <StyledTitle>TechnicolorEffect</StyledTitle>
      <StyledIntroduction>This effect will make the scene look like it is displayed on a technicolor screen.</StyledIntroduction>
...
export default TechnicolorEffectDoc;
